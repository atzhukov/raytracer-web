...
import {
	...
	rgbaToHsla,
	hslaToRgba,
} from '@/components/ui/external/shadcn-input-color/color-converter'
import {z} from 'zod'
...
export default function InputColor({
		...
		if (
			...
			try {
				if (formattedValue.length === maxLength) {
					...
					setHexInputError('The color value is invalid.')
				}
	...
	// 	return (
	// 		typeof globalThis.window !== 'undefined' && 'EyeDropper' in globalThis
	// 	)
	// }
